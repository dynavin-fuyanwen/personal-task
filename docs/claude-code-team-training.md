...
```
你: "查看我负责的 JIRA ticket"
你: "把 TASK-123 的状态改为进行中"
```
...
> **文档结束**
>
> 本文档由 Claude Code 协助创建。如需更新，请修改源文件或联系项目负责人。
>
> 下次培训主题预告：如何用 Claude Code + MCP 打通从需求到部署的全流程自动化。
